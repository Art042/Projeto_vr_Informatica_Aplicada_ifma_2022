...
def lvl_2():
    resource = 'quarto2.osgb'

    viz.setMultiSample(4)
    vizconnect.go('config.py')
    vizinfo.InfoPanel('Coloque os Objetos no Local que voce julga o certo')
    ...
    pyramid.texture(viz.addTexture('images/lvl2/fogo.jpg'))
    torus.texture(viz.addTexture('images/lvl2/gelo.jpg'))
    box.texture(viz.addTexture('images/lvl2/raio.jpg'))
